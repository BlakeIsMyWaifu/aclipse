...
exports.run = (client, message, args) => {
  if (!args[0]) return message.channel.send(':negative_squared_cross_mark: What term would you like me to look up?');
  ...
  let url = "http://api.urbandictionary.com/v0/define?term=" + args.join(' ');
  request.get({
    url: url,
    json: true,
